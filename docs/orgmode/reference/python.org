...
~yoda.donatedHydrogenBond~ are bound. ~Frame.rdf~ is ~(r, g)~;
...
Ice-score ~--family~, contact pairs, polar/apolar domains, and
type-resolved ~rho(z)~ are the ~seams~ CLI in seams-core 2.5.0,
not ~Frame~ methods.
