...
- The engine fixture dump, either:
  ...
  - from [[https://github.com/d-SEAMS/seams-core][seams-core]]:
...
[[https://github.com/d-SEAMS/yodaStruct][yodaStruct]]. This tutorial
...
[[https://github.com/d-SEAMS/seams-core][seams-core]] for ~seams~,
and [[https://github.com/d-SEAMS/yodaStruct][yodaStruct]] for
~require("dseams")~.

* Next Steps

- [[file:../howto/ase.org][Classify ASE Atoms]] :: ~from_ase~ / ~to_ase~
- [[file:../howto/solvis.org][View a frame in solvis]] :: optional extra
- [[file:../explanation/yoda-surface.org][The yoda surface]] :: why helpers stay in Python
