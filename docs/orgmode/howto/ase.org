...
are represented internally in LAMMPS restricted-triclinic form. After ~chill_plus~ / ~chill~,
...
- [[file:troubleshooting.org][Troubleshooting]] :: periodicity, singular cells, missing H
